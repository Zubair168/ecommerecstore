    ...
    if (id != null && id.isNotEmpty) {
      try {
        ...
        if (mounted) {
          ...
          setState(() {
            _product = data;
            _images = (imgs != null && imgs.isNotEmpty) ? imgs : _fallbackImages;
            _loading = false;
          });
        }
      } catch (_) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Category & title
          Text(_product?['category'] ?? 'Clothing', style: const TextStyle(fontSize: 11, color: Color(0xFF98A2B3))),
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  _product?['badge'] ?? '',
                  style: const TextStyle(color: kOrange, fontWeight: FontWeight.w800, fontSize: 11),
                ),
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              Text('${(_product?['rating'] ?? 0)}', style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 12, color: Color(0xFF101828))),
              const SizedBox(width: 4),
              Text('( ${_product?['reviewCount'] ?? 0} reviews )', style: const TextStyle(fontSize: 11, color: Color(0xFF98A2B3))),
            ],
          ),
          ...
          Row(
            children: [
              Text(
                ...
                style: const TextStyle(color: kOrange, fontWeight: FontWeight.w900, fontSize: 18),
              ),
              const SizedBox(width: 8),
              if (_originalPrice != null)
                Text(
                  '\$${_originalPrice!.toStringAsFixed(2)}',
                  style: const TextStyle(decoration: TextDecoration.lineThrough, color: Color(0xFF98A2B3), fontSize: 13),
                ),
            ],
          ),
          ...
          Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.confirmation_number_outlined, color: Color(0xFF475467), size: 18),
                SizedBox(width: 8),
                Text('Coupons & Vouchers', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF344054))),
                Spacer(),
                Icon(Icons.chevron_right_rounded, color: Color(0xFF98A2B3), size: 20),
              ],
            ),
          ),
                    ...
                    onPressed: () {
                      for (int i = 0; i < _quantity; i++) {
                        cart.addItem(
                          ...
                          category: _product?['category'] ?? 'General',
                          price: _price,
                          image: _images.isNotEmpty ? _images.first : AppAssets.catPhotoBags,
                        );
                      }
